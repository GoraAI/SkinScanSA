...
- [x] **Task 1.1**: Update Color.kt with Glow Guide palette
...
- [x] **Task 1.2**: Update Theme.kt with dark color scheme
  - Acceptance: DarkColorScheme uses new palette, GlowGuideTheme composable works

- [x] **Task 1.3**: Add glassmorphism utility modifiers
...
- [x] Build verification - app compiles without errors
